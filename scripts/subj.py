...
def test(shots=10, model_name='/root/input/ckpt/models--distilgpt2', retriever=RandomRetriever, seed=42):
...
def test_naive(ice_num, data, model_name, retriever, seed):
    ...
    ice_dict = "</E>Review: </text>\Subjectivity: Subjective </S>% Objective </O>%"

    # Inference prompt template
    tp_dict = {
        '0' : "</E>Review: </text> Subjectivity: Subjective",
        '1' : "</E>Review: </text> Subjectivity: Objective"
    }
    ...
    column_token_map = {'text': '</text>', '1' : '</O>', '0' : '</S>' }
...
def test_sequence(ice_num, data, model_name, retriever, seed):
    ...
    # ICL exemplar template
    ice_dict = "</E>Review: </text>\nSubjectivity: </Label1> </1>% </Label2> </2>%"
...
def test_binning(ice_num, data, model_name, retriever, seed):
    ...
    # ICL exemplar template
    ice_dict = "</E>Review: </text>\nSubjectivity: </Label1> is very likely, </Label2> is not very likely"
