...
# Open both files
with open('data/sst5/train_sst5.jsonl', 'r') as f2, open('data/sst5/train_label_sst5.jsonl', 'r') as f1:
    lines1 = f1.readlines()
    lines2 = f2.readlines()
...
df = process_jsonl('data/sst5/train_label_sst5.jsonl', 'data/sst5/train_label_sst5.jsonl')
